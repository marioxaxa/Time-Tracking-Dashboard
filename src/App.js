...
const styles = {
  Trabalho: {
    backgroundColor: "hsla(15, 66%, 66%, 1)",
  },
  Lazer: {
    backgroundColor: "hsla(195, 50%, 59%, 1)",
  },
  Estudo: {
    backgroundColor: "hsla(348, 85%, 71%, 1)",
  },
  Exercicio: {
    backgroundColor: "hsla(145, 64%, 55%, 1)",
  },
  Social: {
    backgroundColor: "hsla(263, 74%, 52%, 1)",
  },
  Self: {
    backgroundColor: "hsla(38, 78%, 65%, 1)",
  }
}
...
function boxColor(type) {
    ...
    case "Trabalho":
      return (
        <div className='Box-top'  style={styles.Trabalho}>
          {boxtype(type)}
        </div>
      )
    case "Lazer":
      return (
        <div className='Box-top'  style={styles.Lazer}>
          {boxtype(type)}
        </div>
      )
    case "Estudo":
      return (
        <div className='Box-top'  style={styles.Estudo}>
          {boxtype(type)}
        </div>
      )
    case "Exercicio":
      return (
        <div className='Box-top'  style={styles.Exercicio}>
          {boxtype(type)}
        </div>
      )
    case "Social":
      return (
        <div className='Box-top'  style={styles.Social}>
          {boxtype(type)}
        </div>
      )
    case "Saúde":
      return (
        <div className='Box-top'  style={styles.Self}>
          {boxtype(type)}
        </div>
      )
    default:
...
function App() {
  return (
    <div className="App">
      <div className='Grid'>
        <div>
          <div className='Box-top' id='Profile-top'>
